package moe.yukoDotMoe.cuteanimegirl.service
...
import moe.yukoDotMoe.cuteanimegirl.MockGpsApp
            ...
            try {
                ...
                if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (json.getString("status") == "success") {
                        ...
                        // Add small random offset (±0.001 to ±0.005 degrees, ~100-500 meters)
